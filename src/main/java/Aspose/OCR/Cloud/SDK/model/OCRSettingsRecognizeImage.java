...
public class OCRSettingsRecognizeImage {
  ...
  public OCRSettingsRecognizeImage() {
  }

  public OCRSettingsRecognizeImage language(Language language) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage makeSkewCorrect(Boolean makeSkewCorrect) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage makeBinarization(Boolean makeBinarization) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage makeSpellCheck(Boolean makeSpellCheck) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage makeContrastCorrection(Boolean makeContrastCorrection) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage makeUpsampling(Boolean makeUpsampling) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage dsrMode(DsrMode dsrMode) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage dsrConfidence(DsrConfidence dsrConfidence) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage resultType(ResultType resultType) {
  ...
  **/
  ...
  public OCRSettingsRecognizeImage regions(List<OCRRegion> regions) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OCRSettingsRecognizeImage ocRSettingsRecognizeImage = (OCRSettingsRecognizeImage) o;
    return Objects.equals(this.language, ocRSettingsRecognizeImage.language) &&
        Objects.equals(this.makeSkewCorrect, ocRSettingsRecognizeImage.makeSkewCorrect) &&
        Objects.equals(this.makeBinarization, ocRSettingsRecognizeImage.makeBinarization) &&
        Objects.equals(this.makeSpellCheck, ocRSettingsRecognizeImage.makeSpellCheck) &&
        Objects.equals(this.makeContrastCorrection, ocRSettingsRecognizeImage.makeContrastCorrection) &&
        Objects.equals(this.makeUpsampling, ocRSettingsRecognizeImage.makeUpsampling) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to OCRSettingsRecognizeImage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OCRSettingsRecognizeImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OCRSettingsRecognizeImage is not found in the empty JSON string", OCRSettingsRecognizeImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OCRSettingsRecognizeImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OCRSettingsRecognizeImage` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OCRSettingsRecognizeImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OCRSettingsRecognizeImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OCRSettingsRecognizeImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OCRSettingsRecognizeImage.class));

       return (TypeAdapter<T>) new TypeAdapter<OCRSettingsRecognizeImage>() {
           @Override
           public void write(JsonWriter out, OCRSettingsRecognizeImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OCRSettingsRecognizeImage read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OCRSettingsRecognizeImage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OCRSettingsRecognizeImage
  * @throws IOException if the JSON string is invalid with respect to OCRSettingsRecognizeImage
  */
  public static OCRSettingsRecognizeImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OCRSettingsRecognizeImage.class);
  }

 /**
  * Convert an instance of OCRSettingsRecognizeImage to an JSON string
  *
  * @return JSON string
  */
