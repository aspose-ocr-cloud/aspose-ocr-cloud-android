...
public class OCRSettingsRecognizeTable {
  ...
  public OCRSettingsRecognizeTable() {
  }

  public OCRSettingsRecognizeTable language(Language language) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable makeSkewCorrect(Boolean makeSkewCorrect) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable makeSpellCheck(Boolean makeSpellCheck) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable makeContrastCorrection(Boolean makeContrastCorrection) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable resultTypeTable(ResultTypeTable resultTypeTable) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable makeUpsampling(Boolean makeUpsampling) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable dsrMode(DsrMode dsrMode) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable dsrConfidence(DsrConfidence dsrConfidence) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable resultType(ResultType resultType) {
  ...
  **/
  ...
  public OCRSettingsRecognizeTable regions(List<OCRRegion> regions) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OCRSettingsRecognizeTable ocRSettingsRecognizeTable = (OCRSettingsRecognizeTable) o;
    return Objects.equals(this.language, ocRSettingsRecognizeTable.language) &&
        Objects.equals(this.makeSkewCorrect, ocRSettingsRecognizeTable.makeSkewCorrect) &&
        ...
        Objects.equals(this.dsrConfidence, ocRSettingsRecognizeTable.dsrConfidence) &&
        Objects.equals(this.resultType, ocRSettingsRecognizeTable.resultType) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to OCRSettingsRecognizeTable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OCRSettingsRecognizeTable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OCRSettingsRecognizeTable is not found in the empty JSON string", OCRSettingsRecognizeTable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OCRSettingsRecognizeTable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OCRSettingsRecognizeTable` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OCRSettingsRecognizeTable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OCRSettingsRecognizeTable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OCRSettingsRecognizeTable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OCRSettingsRecognizeTable.class));

       return (TypeAdapter<T>) new TypeAdapter<OCRSettingsRecognizeTable>() {
           @Override
           public void write(JsonWriter out, OCRSettingsRecognizeTable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OCRSettingsRecognizeTable read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OCRSettingsRecognizeTable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OCRSettingsRecognizeTable
  * @throws IOException if the JSON string is invalid with respect to OCRSettingsRecognizeTable
  */
  public static OCRSettingsRecognizeTable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OCRSettingsRecognizeTable.class);
  }

 /**
  * Convert an instance of OCRSettingsRecognizeTable to an JSON string
  *
  * @return JSON string
  */
