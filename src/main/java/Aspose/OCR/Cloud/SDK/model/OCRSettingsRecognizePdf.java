...
public class OCRSettingsRecognizePdf {
  ...
  public OCRSettingsRecognizePdf() {
  }

  public OCRSettingsRecognizePdf language(Language language) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf makeSkewCorrect(Boolean makeSkewCorrect) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf makeSpellCheck(Boolean makeSpellCheck) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf makeContrastCorrection(Boolean makeContrastCorrection) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf dsrMode(DsrMode dsrMode) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf dsrConfidence(DsrConfidence dsrConfidence) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf resultType(ResultType resultType) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf makeUpsampling(Boolean makeUpsampling) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf resultTypeTable(ResultTypeTable resultTypeTable) {
  ...
  **/
  ...
  public OCRSettingsRecognizePdf regions(List<OCRRegion> regions) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OCRSettingsRecognizePdf ocRSettingsRecognizePdf = (OCRSettingsRecognizePdf) o;
    return Objects.equals(this.language, ocRSettingsRecognizePdf.language) &&
        Objects.equals(this.makeSkewCorrect, ocRSettingsRecognizePdf.makeSkewCorrect) &&
        Objects.equals(this.makeSpellCheck, ocRSettingsRecognizePdf.makeSpellCheck) &&
        Objects.equals(this.makeContrastCorrection, ocRSettingsRecognizePdf.makeContrastCorrection) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to OCRSettingsRecognizePdf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OCRSettingsRecognizePdf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OCRSettingsRecognizePdf is not found in the empty JSON string", OCRSettingsRecognizePdf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OCRSettingsRecognizePdf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OCRSettingsRecognizePdf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OCRSettingsRecognizePdf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OCRSettingsRecognizePdf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OCRSettingsRecognizePdf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OCRSettingsRecognizePdf.class));

       return (TypeAdapter<T>) new TypeAdapter<OCRSettingsRecognizePdf>() {
           @Override
           public void write(JsonWriter out, OCRSettingsRecognizePdf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OCRSettingsRecognizePdf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OCRSettingsRecognizePdf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OCRSettingsRecognizePdf
  * @throws IOException if the JSON string is invalid with respect to OCRSettingsRecognizePdf
  */
  public static OCRSettingsRecognizePdf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OCRSettingsRecognizePdf.class);
  }

 /**
  * Convert an instance of OCRSettingsRecognizePdf to an JSON string
  *
  * @return JSON string
  */
