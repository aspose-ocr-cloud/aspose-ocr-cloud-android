...
public class OCRSettingsDjVu2PDF {
  ...
  public OCRSettingsDjVu2PDF() {
  }

  public OCRSettingsDjVu2PDF language(Language language) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF rotate(Integer rotate) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF makeSkewCorrect(Boolean makeSkewCorrect) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF makeSpellCheck(Boolean makeSpellCheck) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF makeContrastCorrection(Boolean makeContrastCorrection) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF makeBinarization(Boolean makeBinarization) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF makeUpsampling(Boolean makeUpsampling) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF dsrMode(DsrMode dsrMode) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF dsrConfidence(DsrConfidence dsrConfidence) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF resultType(ResultType resultType) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF resultTypeTable(ResultTypeTable resultTypeTable) {
  ...
  **/
  ...
  public OCRSettingsDjVu2PDF regions(List<OCRRegion> regions) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OCRSettingsDjVu2PDF ocRSettingsDjVu2PDF = (OCRSettingsDjVu2PDF) o;
    return Objects.equals(this.language, ocRSettingsDjVu2PDF.language) &&
        Objects.equals(this.rotate, ocRSettingsDjVu2PDF.rotate) &&
        Objects.equals(this.makeSkewCorrect, ocRSettingsDjVu2PDF.makeSkewCorrect) &&
        Objects.equals(this.makeSpellCheck, ocRSettingsDjVu2PDF.makeSpellCheck) &&
        Objects.equals(this.makeContrastCorrection, ocRSettingsDjVu2PDF.makeContrastCorrection) &&
        Objects.equals(this.makeBinarization, ocRSettingsDjVu2PDF.makeBinarization) &&
        Objects.equals(this.makeUpsampling, ocRSettingsDjVu2PDF.makeUpsampling) &&
        Objects.equals(this.dsrMode, ocRSettingsDjVu2PDF.dsrMode) &&
        Objects.equals(this.dsrConfidence, ocRSettingsDjVu2PDF.dsrConfidence) &&
        Objects.equals(this.resultType, ocRSettingsDjVu2PDF.resultType) &&
        Objects.equals(this.resultTypeTable, ocRSettingsDjVu2PDF.resultTypeTable) &&
        Objects.equals(this.regions, ocRSettingsDjVu2PDF.regions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(language, rotate, makeSkewCorrect, makeSpellCheck, makeContrastCorrection, makeBinarization, makeUpsampling, dsrMode, dsrConfidence, resultType, resultTypeTable, regions);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OCRSettingsDjVu2PDF
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OCRSettingsDjVu2PDF.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OCRSettingsDjVu2PDF is not found in the empty JSON string", OCRSettingsDjVu2PDF.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OCRSettingsDjVu2PDF.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OCRSettingsDjVu2PDF` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OCRSettingsDjVu2PDF.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OCRSettingsDjVu2PDF' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OCRSettingsDjVu2PDF> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OCRSettingsDjVu2PDF.class));

       return (TypeAdapter<T>) new TypeAdapter<OCRSettingsDjVu2PDF>() {
           @Override
           public void write(JsonWriter out, OCRSettingsDjVu2PDF value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OCRSettingsDjVu2PDF read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OCRSettingsDjVu2PDF given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OCRSettingsDjVu2PDF
  * @throws IOException if the JSON string is invalid with respect to OCRSettingsDjVu2PDF
  */
  public static OCRSettingsDjVu2PDF fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OCRSettingsDjVu2PDF.class);
  }

 /**
  * Convert an instance of OCRSettingsDjVu2PDF to an JSON string
  *
  * @return JSON string
  */
